        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 z-10 bg-slate-50 dark:bg-slate-800">
            <tr>
              ...
              <th className="whitespace-nowrap px-3 py-2 text-right font-semibold text-green-600 dark:text-green-400">Max Rise</th>
          ...
          <tbody>
            {pageRows.map((path) => (
              <tr key={path.pathId} className="border-t border-slate-100 dark:border-slate-800">
                ...
                <td className="whitespace-nowrap px-3 py-1.5 text-right tabular-nums text-green-600 dark:text-green-400">
